import unittest
from backend.core.semantic_router import SemanticRouter, Route
from backend.core.semantic_router.samples import productSample, chitchatSample
...
class RouterTestCase(unittest.TestCase):
    def setUp(self):
        ...
        productRoute = Route(
            name=self.PRODUCT_ROUTE_NAME,
            samples=productSample,
        )
        chitchatRoute = Route(
            name=self.CHITCHAT_ROUTE_NAME,
            samples=chitchatSample,
        )
        self.semanticRouter = SemanticRouter(
            routes=[productRoute, chitchatRoute])
